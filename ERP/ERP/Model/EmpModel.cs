...
namespace ERP.Model
{
    class EmpModel
    {
        ...
        public void connection( string prenom,string pass)
        {
            ...
            result = bdd.Select(string.Join(", ", attributes), "T_Employe", "T_societe", attributes, "T_Employe.Soc_id = T_Societe.Soc_id", " T_Employe.Emp_prenom='" + prenom + "' AND T_Employe.Soc_id=" + this.id + " AND T_Employe.Emp_pass='" + cryptPass + "'");
